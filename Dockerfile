...
# Copy the built app and dependencies (node_modules carries the playwright
# runtime).
...
# Writable dir for audit records and screenshot artifacts (all under .data),
# owned by the image's non-root user. Mount a volume at
